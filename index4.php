        ...
        <div id="container">
            <div id="page1">
                <ul class="tabs">
                    ...
                    <li id="tab4" class="active"><a href="index4.php">Super révision</a></li>
                </ul>
                <form action="index4.php" method="get" id="choiceContainer">
                    <h2>Veuillez sélectionner des tables, nous vous proposerons 10 calculs en fonction de ces tables</h2>
                    ...
                    <?php if (isset($_GET['envoyer'])){include ('superRevision.php');}?>
                    <?php if (isset($_GET['result'])){include ('winSuperRev.php');}?>
                </form>
